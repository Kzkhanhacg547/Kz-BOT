...
const fontsLink = 40
    ...
    if (!location || !name || !gender || !vanity || !uid || !chuky) {
      return res.json({
        ...
        example: {
          message: "https://88a09d18-0a10-4ac1-9aa7-35e6da1ad8ce-00-1ph67irjzn20k.sisko.replit.dev/cardinfo?location=tr%C3%AAn%20m%E1%BA%B7t%20%C4%91%E1%BA%A5t&name=Kz&gender=Nam&vanity=Kz&uid=100081129610697&chuky=Kz"
        }
      })
    }
    else {
