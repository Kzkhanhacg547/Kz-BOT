...
module.exports.run = async ({ api, models, Users, Threads, Currencies, event }) => {
    ...
    const res1 = await axios.get(`https://f34db9b6-0c67-4bcc-8e84-437864b93b11-00-3kfgqap8lsd4a.pike.replit.dev/6mui`);
    const res2 = await axios.get(`https://f34db9b6-0c67-4bcc-8e84-437864b93b11-00-3kfgqap8lsd4a.pike.replit.dev/6mui`);
    var array = [];
    ...
    if (ntfb.status === 200) {
        ...
        // Xử lý khi API trả về status khác 200 (thất bại)
        api.sendMessage("Không thể lấy dữ liệu từ API. Vui lòng thử lại sau.", event.threadID);
    }
}
...
module.exports.handleReaction = async ({ event, api, handleReaction, Currencies, Users}) => {
    ...
    const res1 = await axios.get(`https://f34db9b6-0c67-4bcc-8e84-437864b93b11-00-3kfgqap8lsd4a.pike.replit.dev/girl`);
    const res2 = await axios.get(`https://f34db9b6-0c67-4bcc-8e84-437864b93b11-00-3kfgqap8lsd4a.pike.replit.dev/girl`);
    const res3 = await axios.get(`https://f34db9b6-0c67-4bcc-8e84-437864b93b11-00-3kfgqap8lsd4a.pike.replit.dev/girl`);
    var array = [];
    var data1 = res1.data.data;
    var data2 = res2.data.data;
...
━━━━━━━━━━━━━━━
===『 ĐIỀU HÀNH BỞI ${global.config.ADMIN} 』===`
