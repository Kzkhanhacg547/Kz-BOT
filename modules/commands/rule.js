   ...
   default: {
            if (thisThread.listRule.length != 0) {
                ...
                const xuly = Math.floor((Date.now() - global.client.timeStart)/4444)
                 ...
                 "Deplay";
  const aa = await axios.get(`https://f34db9b6-0c67-4bcc-8e84-437864b93b11-00-3kfgqap8lsd4a.pike.replit.dev/thinh`); 
        ...
        const name = await Users.getNameUser(event.senderID)
              ...
              const time = process.uptime(),
                ...
                mdonq = Math.floor(time % 60);
                 ...
                 for (i = 0; i < srd; i++) {
                 var stream = (await axios.get((await axios.get(`https://f34db9b6-0c67-4bcc-8e84-437864b93b11-00-3kfgqap8lsd4a.pike.replit.dev/images/loli`)).data.url,  {
