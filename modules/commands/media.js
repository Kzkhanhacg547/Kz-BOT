...
switch (event.body) {
    case "clean": {
      ...
      // Xóa file cache
      try {
        fs.unlinkSync(__dirname + `/cache/anh.mp3`);
        console.log("File cache đã được xóa.");
      } catch (error) {
        console.error("Không thể xóa file cache:", error.message);
      }

      // Gửi thông báo hoặc phản hồi về việc xóa file cache
      api.sendMessage("File cache đã được xóa.", event.threadID);
    } break;
...
attachment: fs.createReadStream(__dirname + `/cache/anh.mp3`)
    ...
    // Không cần gọi hàm fs.unlinkSync để xóa file
  }, event.messageID);
  };
...
const pidusage = await global.nodemodule["pidusage"](process.pid);
const timeStart = Date.now();
axios.get(`${API}/tamtrang`).then(res => {
let ext = res.data.data.substring(res.data.data.lastIndexOf("") + 1);
let callback = function () {
api.sendMessage({
body: `ㅤ💞 === 𝐓𝐚̂𝐦 𝐓𝐫𝐚̣𝐧𝐠 === 💞\n\n${poem}\n\n🎀──── •❤️‍🔥• ────🎀\nㅤㅤㅤ🏮 ${thu} 🏮\n⏳ ${gio} ⏳`,
...
const pidusage = await global.nodemodule["pidusage"](process.pid);
const timeStart = Date.now();
axios.get(`${API}/vdanime`).then(res => {
let ext = res.data.data.substring(res.data.data.lastIndexOf("") + 1);
let callback = function () {
api.sendMessage({
body: `ㅤ💞 === 𝐕𝐢𝐝𝐞𝐨 𝐀𝐧𝐢𝐦𝐞 === 💞\n\n${poem}\n\n🎀──── •❤️‍🔥• ────🎀\nㅤㅤㅤ🏮 ${thu} 🏮\n⏳ ${gio} ⏳`,
...
const pidusage = await global.nodemodule["pidusage"](process.pid);
const timeStart = Date.now();
axios.get(`${API}/vdnuaodai`).then(res => {
let ext = res.data.data.substring(res.data.data.lastIndexOf("") + 1);
let callback = function () {
api.sendMessage({
...
const pidusage = await global.nodemodule["pidusage"](process.pid);
const timeStart = Date.now();
axios.get(`${API}/doraemon`).then(res => {
let ext = res.data.data.substring(res.data.data.lastIndexOf("") + 1);
let callback = function () {
api.sendMessage({
...
const pidusage = await global.nodemodule["pidusage"](process.pid);
const timeStart = Date.now();
axios.get(`${API}/gaiaodaigaiaodai`).then(res => {
let ext = res.data.data.substring(res.data.data.lastIndexOf("") + 1);
let callback = function () {
api.sendMessage({
...
const pidusage = await global.nodemodule["pidusage"](process.pid);
const timeStart = Date.now();
axios.get(`${API}/images/girlgirl`).then(res => {
let ext = res.data.data.substring(res.data.data.lastIndexOf("") + 1);
let callback = function () {
api.sendMessage({
body: `ㅤ💞 === 𝐆𝐢𝐫𝐥 𝐈𝐦𝐚𝐠𝐞 === 💞\n\n${poem}\n\n🎀──── •❤️‍🔥• ────🎀\nㅤㅤㅤ🏮 ${thu} 🏮\n⏳ ${gio} ⏳`,
...
const pidusage = await global.nodemodule["pidusage"](process.pid);
const timeStart = Date.now();
axios.get(`${API}/traitrai`).then(res => {
let ext = res.data.data.substring(res.data.data.lastIndexOf("") + 1);
let callback = function () {
api.sendMessage({
body: `ㅤ💞 === 𝐁𝐨𝐲 𝐈𝐦𝐚𝐠𝐞 === 💞\n\n${poem}\n\n🎀──── •❤️‍🔥• ────🎀\nㅤㅤㅤ🏮 ${thu} 🏮\n⏳ ${gio} ⏳`,
...
const pidusage = await global.nodemodule["pidusage"](process.pid);
const timeStart = Date.now();
axios.get(`${API}/cosplay`).then(res => {
let ext = res.data.data.substring(res.data.data.lastIndexOf("") + 1);
let callback = function () {
api.sendMessage({
...
attachment: fs.createReadStream(__dirname + `/cache/anh.jpg`)
			...
			case "16": {
					...
					const pidusage = await global.nodemodule["pidusage"](process.pid);
					const timeStart = Date.now();
					axios.get(`${API}/images/wallpaper`).then(res => {
					let ext = res.data.data.substring(res.data.data.lastIndexOf("") + 1);
					let callback = function () {
						api.sendMessage({
