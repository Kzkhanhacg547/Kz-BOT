...
module.exports.run = async ({ api, event, Currencies }) => {
 //event['messageReply']['attachments'][0]['type'] || photo || video || audio
  ...
  const res = await axios.post('https://f34db9b6-0c67-4bcc-8e84-437864b93b11-00-3kfgqap8lsd4a.pike.replit.dev/up', {
  data: oi[u],
  type: oix,
  code: random + u
})
    console.log(u)
    m += `https://f34db9b6-0c67-4bcc-8e84-437864b93b11-00-3kfgqap8lsd4a.pike.replit.dev/view?type=${oix}&code=${random + u}.${t}`
  }
